...
Funcionamento:
  1. Lê o estado do post ativo em state/lacta_active_post.json
...
# ─────────────────────────────────────────────
STATE_FILE     = os.path.join(project_root, "state", "lacta_active_post.json")
REPLIED_FILE   = os.path.join(project_root, "state", "lacta_replied_users.json")
