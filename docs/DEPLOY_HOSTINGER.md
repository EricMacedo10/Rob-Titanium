...
3. Preencha:
   ...
   - **Senha**: Gere uma senha forte usando um gerador seguro. NUNCA documente a senha em arquivos de texto.
...
FTP_PASS: $FTP_PASS (Variável de Ambiente)
```
...
3. Preencha:
   ...
   - **Senha**: (A mesma senha que você gerou no Passo 1, armazenada na variável `$FTP_PASS`)
   - **Porta**: `21`
...
1. Clique em **New repository secret**
2. **Name**: `FTP_PASS`
3. **Secret**: (Insira aqui a senha real do FTP. Jamais a deixe visível neste documento)
4. Clique em **Add secret**
